...
function Customize() {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] '>
      ...
      {selectedImage && <button className='min-w-[150px] h-[60px] mt-[30px] text-black font-semibold cursor-pointer bg-white rounded-full text-[19px] hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-white/20' onClick={() => navigate("/customize2")}>Next</button>}
